...
public class OboAuthResponseDiffblueTest {
  ...
  public void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, oboAuthResponse2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link OboAuthResponse#equals(Object)}
   */
  @Test
  @MethodsUnderTest({"boolean OboAuthResponse.equals(Object)", "int OboAuthResponse.hashCode()"})
   ...
   */
  @Test
  @MethodsUnderTest({"void OboAuthResponse.<init>()", "String OboAuthResponse.getSessionToken()",
      "OboAuthResponse OboAuthResponse.sessionToken(String)", "void OboAuthResponse.setSessionToken(String)",
