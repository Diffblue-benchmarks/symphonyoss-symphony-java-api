...
public class UserSearchResultsDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link UserSearchResults} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link UserSearchResults#addUsersItem(UserV2)}
   */
  @Test
  ...
  public void testAddUsersItem_givenUserSearchResults() {
    ...
    // Act and Assert
    assertSame(userSearchResults, userSearchResults.addUsersItem(new UserV2()));
  }

  /**
   * Test {@link UserSearchResults#addUsersItem(UserV2)}.
   * <ul>
   *   <li>Given {@link UserSearchResults} (default constructor) users {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link UserSearchResults#addUsersItem(UserV2)}
   */
   ...
   */
  @Test
  @MethodsUnderTest({"boolean UserSearchResults.equals(Object)", "int UserSearchResults.hashCode()"})
  public void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, userSearchResults2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link UserSearchResults#equals(Object)}
   */
  @Test
  @MethodsUnderTest({"boolean UserSearchResults.equals(Object)", "int UserSearchResults.hashCode()"})
   ...
   */
  @Test
  @MethodsUnderTest({"void UserSearchResults.<init>()", "UserSearchResults UserSearchResults.count(Long)",
      "Long UserSearchResults.getCount()", "Long UserSearchResults.getLimit()",
      "UserSearchQuery UserSearchResults.getSearchQuery()", "Long UserSearchResults.getSkip()",
      "List UserSearchResults.getUsers()", "UserSearchResults UserSearchResults.limit(Long)",
      "UserSearchResults UserSearchResults.searchQuery(UserSearchQuery)", "void UserSearchResults.setCount(Long)",
      "void UserSearchResults.setLimit(Long)", "void UserSearchResults.setSearchQuery(UserSearchQuery)",
      "void UserSearchResults.setSkip(Long)", "void UserSearchResults.setUsers(List)",
      "UserSearchResults UserSearchResults.skip(Long)", "String UserSearchResults.toString()",
  ...
  public void testGettersAndSetters() {
    ...
    // Assert
    assertEquals("class UserSearchResults {\n" + "    count: 3\n" + "    skip: 1\n" + "    limit: 1\n"
