...
public class V2MemberInfoDiffblueTest {
   ...
   */
  @Test
  @MethodsUnderTest({"void V2MemberInfo.<init>()", "Boolean V2MemberInfo.getIsCreator()",
      ...
      "void V2MemberInfo.setIsCreator(Boolean)", "void V2MemberInfo.setIsOwner(Boolean)",
      "void V2MemberInfo.setJoinDate(Long)", "void V2MemberInfo.setUser(V2MemberUserDetail)",
      "String V2MemberInfo.toString()", "V2MemberInfo V2MemberInfo.user(V2MemberUserDetail)"})
