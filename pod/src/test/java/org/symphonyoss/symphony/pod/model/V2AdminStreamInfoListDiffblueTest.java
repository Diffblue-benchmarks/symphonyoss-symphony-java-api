...
public class V2AdminStreamInfoListDiffblueTest {
  /**
   * Test {@link V2AdminStreamInfoList#equals(Object)}, and {@link
   * V2AdminStreamInfoList#hashCode()}.
   *
   * <ul>
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean V2AdminStreamInfoList.equals(Object)",
    "int V2AdminStreamInfoList.hashCode()"
  })
  public void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(v2AdminStreamInfoList.hashCode(), v2AdminStreamInfoList2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link V2AdminStreamInfoList#equals(Object)}
   */
  @Test
  @ManagedByDiffblue
  @MethodsUnderTest({
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void V2AdminStreamInfoList.<init>()",
    "java.lang.String V2AdminStreamInfoList.toString()"
  })
  public void testGettersAndSetters() {
    // Arrange, Act and Assert
    assertEquals(
        "class V2AdminStreamInfoList {\n    []\n}", new V2AdminStreamInfoList().toString());
  }
}
