...
public class PasswordDiffblueTest {
   ...
   */
  @Test
  @MethodsUnderTest({"void Password.<init>()", "String Password.getHPassword()", "String Password.getHSalt()",
      "String Password.getKhPassword()", "String Password.getKhSalt()", "Password Password.hPassword(String)",
      "Password Password.hSalt(String)", "Password Password.khPassword(String)", "Password Password.khSalt(String)",
      "void Password.setHPassword(String)", "void Password.setHSalt(String)", "void Password.setKhPassword(String)",
      "void Password.setKhSalt(String)", "String Password.toString()"})
