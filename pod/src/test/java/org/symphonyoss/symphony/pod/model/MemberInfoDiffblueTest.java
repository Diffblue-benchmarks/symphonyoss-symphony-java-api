...
public class MemberInfoDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link MemberInfo#equals(Object)}
   */
  @Test
  @MethodsUnderTest({"boolean MemberInfo.equals(Object)", "int MemberInfo.hashCode()"})
   ...
   */
  @Test
  @MethodsUnderTest({"void MemberInfo.<init>()", "Long MemberInfo.getId()", "Long MemberInfo.getJoinDate()",
      "Boolean MemberInfo.getOwner()", "MemberInfo MemberInfo.id(Long)", "MemberInfo MemberInfo.joinDate(Long)",
      "MemberInfo MemberInfo.owner(Boolean)", "void MemberInfo.setId(Long)", "void MemberInfo.setJoinDate(Long)",
      "void MemberInfo.setOwner(Boolean)", "String MemberInfo.toString()"})
