...
public class CompanyCertAttributesDiffblueTest {
  /**
   * Test {@link CompanyCertAttributes#equals(Object)}, and {@link
   * CompanyCertAttributes#hashCode()}.
   *
   * <ul>
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean CompanyCertAttributes.equals(Object)",
    "int CompanyCertAttributes.hashCode()"
  })
  public void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(companyCertAttributes.hashCode(), companyCertAttributes2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link CompanyCertAttributes#equals(Object)}
   */
  @Test
  @ManagedByDiffblue
  @MethodsUnderTest({
  ...
  @MethodsUnderTest({
    ...
    "CompanyCertAttributes CompanyCertAttributes.name(String)",
    ...
    "String CompanyCertAttributes.toString()",
    "CompanyCertAttributes CompanyCertAttributes.type(CompanyCertType)"
  })
