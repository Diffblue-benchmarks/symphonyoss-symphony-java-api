...
public class CompanyCertInfoListInnerDiffblueTest {
  /**
   * Test {@link CompanyCertInfoListInner#equals(Object)}, and {@link
   * CompanyCertInfoListInner#hashCode()}.
   *
   * <ul>
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean CompanyCertInfoListInner.equals(Object)",
    "int CompanyCertInfoListInner.hashCode()"
  })
  public void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(companyCertInfoListInner.hashCode(), companyCertInfoListInner2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link CompanyCertInfoListInner#equals(Object)}
   */
  @Test
  @ManagedByDiffblue
  @MethodsUnderTest({
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void CompanyCertInfoListInner.<init>()",
  ...
  public void testGettersAndSetters() {
    ...
    CompanyCertInfoListInner actualCompanyCertAttributesResult =
        actualCompanyCertInfoListInner.companyCertAttributes(new CompanyCertAttributes());
    CompanyCertInfoListInner actualCompanyCertInfoResult =
        actualCompanyCertInfoListInner.companyCertInfo(new CompanyCertInfo());
    ...
    CompanyCertAttributes actualCompanyCertAttributes =
        actualCompanyCertInfoListInner.getCompanyCertAttributes();

    // Assert
    assertEquals(
        "class CompanyCertInfoListInner {\n"
