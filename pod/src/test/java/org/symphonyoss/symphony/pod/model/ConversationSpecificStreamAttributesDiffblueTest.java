...
public class ConversationSpecificStreamAttributesDiffblueTest {
  /**
   * Test {@link ConversationSpecificStreamAttributes#equals(Object)}, and {@link
   * ConversationSpecificStreamAttributes#hashCode()}.
   *
   * <ul>
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean ConversationSpecificStreamAttributes.equals(Object)",
    "int ConversationSpecificStreamAttributes.hashCode()"
  })
  public void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    // Arrange
    ConversationSpecificStreamAttributes conversationSpecificStreamAttributes =
        new ConversationSpecificStreamAttributes();
    ConversationSpecificStreamAttributes conversationSpecificStreamAttributes2 =
        new ConversationSpecificStreamAttributes();
    ...
    assertEquals(
        conversationSpecificStreamAttributes.hashCode(),
        conversationSpecificStreamAttributes2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link ConversationSpecificStreamAttributes#equals(Object)}
   */
  @Test
  @ManagedByDiffblue
  @MethodsUnderTest({
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void ConversationSpecificStreamAttributes.<init>()",
  ...
  public void testGettersAndSetters() {
    // Arrange and Act
    ConversationSpecificStreamAttributes actualConversationSpecificStreamAttributes =
        new ConversationSpecificStreamAttributes();
    ConversationSpecificStreamAttributes actualMembersResult =
        actualConversationSpecificStreamAttributes.members(new UserIdList());
    ...
    UserIdList actualMembers = actualConversationSpecificStreamAttributes.getMembers();
