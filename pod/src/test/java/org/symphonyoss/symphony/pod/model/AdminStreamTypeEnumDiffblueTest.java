...
public class AdminStreamTypeEnumDiffblueTest {
   ...
   */
  @Test
  @MethodsUnderTest({"boolean AdminStreamTypeEnum.equals(Object)", "int AdminStreamTypeEnum.hashCode()"})
  public void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, adminStreamTypeEnum2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link AdminStreamTypeEnum#equals(Object)}
   */
  @Test
  @MethodsUnderTest({"boolean AdminStreamTypeEnum.equals(Object)", "int AdminStreamTypeEnum.hashCode()"})
   ...
   */
  @Test
  @MethodsUnderTest({"void AdminStreamTypeEnum.<init>()", "TypeEnum AdminStreamTypeEnum.getType()",
      "void AdminStreamTypeEnum.setType(TypeEnum)", "String AdminStreamTypeEnum.toString()",
