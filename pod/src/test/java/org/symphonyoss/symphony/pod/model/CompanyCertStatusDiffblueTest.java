...
public class CompanyCertStatusDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean CompanyCertStatus.equals(Object)",
    "int CompanyCertStatus.hashCode()"
  })
  public void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(companyCertStatus.hashCode(), companyCertStatus2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link CompanyCertStatus#equals(Object)}
   */
  @Test
  @ManagedByDiffblue
  @MethodsUnderTest({
  ...
  @MethodsUnderTest({
    ...
    "String CompanyCertStatus.toString()",
   ...
   *
   * <ul>
   *   <li>When {@code TRUSTED}.
   *   <li>Then return {@code TRUSTED}.
   * </ul>
   *
   * <p>Method under test: {@link TypeEnum#fromValue(String)}
   */
