...
public class UserCreateDiffblueTest {
  ...
  public void testAddRolesItem_givenUserCreate() {
    ...
    // Act
    UserCreate actualAddRolesItemResult = userCreate.addRolesItem("Roles Item");

    // Assert
    assertSame(userCreate, actualAddRolesItemResult);
  }
  ...
  public void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(userCreate.hashCode(), userCreate2.hashCode());
  }
