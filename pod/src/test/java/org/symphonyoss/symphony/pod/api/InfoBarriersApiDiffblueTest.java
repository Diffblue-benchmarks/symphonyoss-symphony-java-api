...
public class InfoBarriersApiDiffblueTest {
   ...
   */
  @Test
  @MethodsUnderTest({"void InfoBarriersApi.<init>(ApiClient)", "ApiClient InfoBarriersApi.getApiClient()",
      "void InfoBarriersApi.setApiClient(ApiClient)"})
  public void testGettersAndSetters() {
    // Arrange and Act
    InfoBarriersApi actualInfoBarriersApi = new InfoBarriersApi(Configuration.getDefaultApiClient());
