...
public class AvatarDiffblueTest {
  ...
  public void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, avatar2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link Avatar#equals(Object)}
   */
  @Test
  @MethodsUnderTest({"boolean Avatar.equals(Object)", "int Avatar.hashCode()"})
  ...
  @MethodsUnderTest({"void Avatar.<init>()", "String Avatar.getSize()", "String Avatar.getUrl()",
      "void Avatar.setSize(String)", "void Avatar.setUrl(String)", "Avatar Avatar.size(String)",
      "String Avatar.toString()", "Avatar Avatar.url(String)"})
