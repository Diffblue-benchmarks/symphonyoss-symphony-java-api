...
public class V4ConnectionRequestedDiffblueTest {
  /**
   * Test {@link V4ConnectionRequested#equals(Object)}, and {@link
   * V4ConnectionRequested#hashCode()}.
   *
   * <ul>
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean V4ConnectionRequested.equals(Object)",
    "int V4ConnectionRequested.hashCode()"
  })
  public void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(v4ConnectionRequested.hashCode(), v4ConnectionRequested2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link V4ConnectionRequested#equals(Object)}
   */
  @Test
  @ManagedByDiffblue
  @MethodsUnderTest({
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void V4ConnectionRequested.<init>()",
    "V4User V4ConnectionRequested.getToUser()",
    "void V4ConnectionRequested.setToUser(V4User)",
    "String V4ConnectionRequested.toString()",
  ...
  public void testGettersAndSetters() {
    ...
    V4User actualToUser = actualV4ConnectionRequested.getToUser();

    // Assert
    assertEquals(
        "class V4ConnectionRequested {\n"
            + "    toUser: class V4User {\n"
            + "        userId: null\n"
            + "        firstName: null\n"
            + "        lastName: null\n"
    ...
    assertSame(toUser, actualToUser);
  }
}
