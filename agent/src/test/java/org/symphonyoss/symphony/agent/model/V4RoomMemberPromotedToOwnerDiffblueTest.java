...
public class V4RoomMemberPromotedToOwnerDiffblueTest {
  /**
   * Test {@link V4RoomMemberPromotedToOwner#equals(Object)}, and {@link V4RoomMemberPromotedToOwner#hashCode()}.
   * <ul>
   ...
   */
  @Test
  @MethodsUnderTest({"boolean V4RoomMemberPromotedToOwner.equals(Object)",
  ...
  public void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, v4RoomMemberPromotedToOwner2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link V4RoomMemberPromotedToOwner#equals(Object)}
   */
  @Test
  @MethodsUnderTest({"boolean V4RoomMemberPromotedToOwner.equals(Object)",
      "int V4RoomMemberPromotedToOwner.hashCode()"})
  ...
  public void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    // Arrange, Act and Assert
    assertNotEquals(new V4RoomMemberPromotedToOwner(), "Different type to V4RoomMemberPromotedToOwner");
  }
   ...
   */
  @Test
  @MethodsUnderTest({"void V4RoomMemberPromotedToOwner.<init>()",
      "V4RoomMemberPromotedToOwner V4RoomMemberPromotedToOwner.affectedUser(V4User)",
      "V4User V4RoomMemberPromotedToOwner.getAffectedUser()", "V4Stream V4RoomMemberPromotedToOwner.getStream()",
  ...
  public void testGettersAndSetters() {
    // Arrange and Act
    V4RoomMemberPromotedToOwner actualV4RoomMemberPromotedToOwner = new V4RoomMemberPromotedToOwner();
    V4RoomMemberPromotedToOwner actualAffectedUserResult = actualV4RoomMemberPromotedToOwner.affectedUser(new V4User());
    ...
    V4RoomMemberPromotedToOwner actualStreamResult = actualV4RoomMemberPromotedToOwner.stream(stream);
    ...
    assertSame(stream, actualV4RoomMemberPromotedToOwner.getStream());
