...
public class V2ImportResponseListDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean V2ImportResponseList.equals(Object)",
    "int V2ImportResponseList.hashCode()"
  })
  public void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(v2ImportResponseList.hashCode(), v2ImportResponseList2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link V2ImportResponseList#equals(Object)}
   */
  @Test
  @ManagedByDiffblue
  @MethodsUnderTest({
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void V2ImportResponseList.<init>()",
    "java.lang.String V2ImportResponseList.toString()"
  })
