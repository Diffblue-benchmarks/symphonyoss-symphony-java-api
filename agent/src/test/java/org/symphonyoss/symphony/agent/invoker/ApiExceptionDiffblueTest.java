...
public class ApiExceptionDiffblueTest {
   ...
   */
  @Test
  @MethodsUnderTest({"void ApiException.<init>()", "void ApiException.<init>(int, String)",
      "void ApiException.<init>(int, String, Map, String)", "void ApiException.<init>(String)",
      "void ApiException.<init>(String, Throwable, int, Map)",
      "void ApiException.<init>(String, Throwable, int, Map, String)", "void ApiException.<init>(Throwable)",
   ...
   * Test getters and setters.
   * <ul>
   *   <li>Then return ResponseBody is {@code Not all who wander are lost}.</li>
   * </ul>
   * <p>
   * Methods under test:
   * <ul>
  ...
  public void testGettersAndSetters_thenReturnResponseBodyIsNotAllWhoWanderAreLost() {
    ...
    // Act
    ApiException actualApiException = new ApiException(1, "An error occurred", responseHeaders,
  ...
  public void testGettersAndSetters_thenReturnResponseBodyIsNotAllWhoWanderAreLost2() {
    ...
    // Act
    ApiException actualApiException = new ApiException("An error occurred", throwable, 1, responseHeaders,
        "Not all who wander are lost");
    int actualCode = actualApiException.getCode();
    String actualResponseBody = actualApiException.getResponseBody();
    Map<String, List<String>> actualResponseHeaders = actualApiException.getResponseHeaders();
   ...
   * <ul>
   *   <li>When {@link Throwable#Throwable()}.</li>
   *   <li>Then return ResponseHeaders Empty.</li>
   * </ul>
   * <p>
   * Methods under test:
   * <ul>
   ...
   * <p>
   * Method under test: {@link ApiException#ApiException(int, Map, String)}
   */
  @Test
  @MethodsUnderTest({"void ApiException.<init>(int, Map, String)"})
  public void testNewApiException() {
    // Arrange and Act
    ApiException actualApiException = new ApiException(1, new HashMap<>(), "Not all who wander are lost");
   ...
   * <p>
   * Method under test: {@link ApiException#ApiException(String, int, Map, String)}
   */
  @Test
  @MethodsUnderTest({"void ApiException.<init>(String, int, Map, String)"})
  public void testNewApiException2() {
    // Arrange and Act
    ApiException actualApiException = new ApiException("An error occurred", 1, new HashMap<>(),
        "Not all who wander are lost");
