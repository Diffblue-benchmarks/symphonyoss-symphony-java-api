...
public class V4PayloadDiffblueTest {
  ...
  public void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, v4Payload2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link V4Payload#equals(Object)}
   */
  @Test
  @MethodsUnderTest({"boolean V4Payload.equals(Object)", "int V4Payload.hashCode()"})
   ...
   */
  @Test
  @MethodsUnderTest({"void V4Payload.<init>()", "V4Payload V4Payload.connectionAccepted(V4ConnectionAccepted)",
      ...
      "V4InstantMessageCreated V4Payload.getInstantMessageCreated()", "V4MessageSent V4Payload.getMessageSent()",
      "V4MessageSuppressed V4Payload.getMessageSuppressed()", "V4RoomCreated V4Payload.getRoomCreated()",
      ...
      "V4RoomReactivated V4Payload.getRoomReactivated()", "V4RoomUpdated V4Payload.getRoomUpdated()",
      "V4SharedPost V4Payload.getSharedPost()", "V4UserJoinedRoom V4Payload.getUserJoinedRoom()",
      "V4UserLeftRoom V4Payload.getUserLeftRoom()",
      "V4Payload V4Payload.instantMessageCreated(V4InstantMessageCreated)",
      "V4Payload V4Payload.messageSent(V4MessageSent)", "V4Payload V4Payload.messageSuppressed(V4MessageSuppressed)",
      "V4Payload V4Payload.roomCreated(V4RoomCreated)", "V4Payload V4Payload.roomDeactivated(V4RoomDeactivated)",
      ...
      "V4Payload V4Payload.roomReactivated(V4RoomReactivated)", "V4Payload V4Payload.roomUpdated(V4RoomUpdated)",
      ...
      "void V4Payload.setMessageSent(V4MessageSent)", "void V4Payload.setMessageSuppressed(V4MessageSuppressed)",
      "void V4Payload.setRoomCreated(V4RoomCreated)", "void V4Payload.setRoomDeactivated(V4RoomDeactivated)",
      ...
      "void V4Payload.setRoomReactivated(V4RoomReactivated)", "void V4Payload.setRoomUpdated(V4RoomUpdated)",
      "void V4Payload.setSharedPost(V4SharedPost)", "void V4Payload.setUserJoinedRoom(V4UserJoinedRoom)",
      "void V4Payload.setUserLeftRoom(V4UserLeftRoom)", "V4Payload V4Payload.sharedPost(V4SharedPost)",
      "String V4Payload.toString()", "V4Payload V4Payload.userJoinedRoom(V4UserJoinedRoom)",
      "V4Payload V4Payload.userLeftRoom(V4UserLeftRoom)"})
  public void testGettersAndSetters() {
    // Arrange and Act
    V4Payload actualV4Payload = new V4Payload();
    V4Payload actualConnectionAcceptedResult = actualV4Payload.connectionAccepted(new V4ConnectionAccepted());
    V4Payload actualConnectionRequestedResult = actualV4Payload.connectionRequested(new V4ConnectionRequested());
    V4Payload actualInstantMessageCreatedResult = actualV4Payload.instantMessageCreated(new V4InstantMessageCreated());
    V4Payload actualMessageSentResult = actualV4Payload.messageSent(new V4MessageSent());
    V4Payload actualMessageSuppressedResult = actualV4Payload.messageSuppressed(new V4MessageSuppressed());
    V4Payload actualRoomCreatedResult = actualV4Payload.roomCreated(new V4RoomCreated());
    V4Payload actualRoomDeactivatedResult = actualV4Payload.roomDeactivated(new V4RoomDeactivated());
    V4Payload actualRoomMemberDemotedFromOwnerResult = actualV4Payload
        .roomMemberDemotedFromOwner(new V4RoomMemberDemotedFromOwner());
    V4Payload actualRoomMemberPromotedToOwnerResult = actualV4Payload
        .roomMemberPromotedToOwner(new V4RoomMemberPromotedToOwner());
    V4Payload actualRoomReactivatedResult = actualV4Payload.roomReactivated(new V4RoomReactivated());
    ...
    V4InstantMessageCreated actualInstantMessageCreated = actualV4Payload.getInstantMessageCreated();
    ...
    V4RoomMemberDemotedFromOwner actualRoomMemberDemotedFromOwner = actualV4Payload.getRoomMemberDemotedFromOwner();
    V4RoomMemberPromotedToOwner actualRoomMemberPromotedToOwner = actualV4Payload.getRoomMemberPromotedToOwner();
