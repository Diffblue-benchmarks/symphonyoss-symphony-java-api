...
public class V4ImportResponseListDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean V4ImportResponseList.equals(Object)",
    "int V4ImportResponseList.hashCode()"
  })
  public void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(v4ImportResponseList.hashCode(), v4ImportResponseList2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link V4ImportResponseList#equals(Object)}
   */
  @Test
  @ManagedByDiffblue
  @MethodsUnderTest({
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void V4ImportResponseList.<init>()",
    "java.lang.String V4ImportResponseList.toString()"
  })
