...
public class V4RoomCreatedDiffblueTest {
  ...
  public void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(v4RoomCreated.hashCode(), v4RoomCreated2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link V4RoomCreated#equals(Object)}
   */
  @Test
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean V4RoomCreated.equals(Object)", "int V4RoomCreated.hashCode()"})
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void V4RoomCreated.<init>()",
    "V4RoomProperties V4RoomCreated.getRoomProperties()",
    "V4Stream V4RoomCreated.getStream()",
    "V4RoomCreated V4RoomCreated.roomProperties(V4RoomProperties)",
    "void V4RoomCreated.setRoomProperties(V4RoomProperties)",
    "void V4RoomCreated.setStream(V4Stream)",
    "V4RoomCreated V4RoomCreated.stream(V4Stream)",
    "String V4RoomCreated.toString()"
  })
  public void testGettersAndSetters() {
    // Arrange and Act
    V4RoomCreated actualV4RoomCreated = new V4RoomCreated();
    V4RoomCreated actualRoomPropertiesResult =
        actualV4RoomCreated.roomProperties(new V4RoomProperties());
    ...
    V4Stream actualStream = actualV4RoomCreated.getStream();
