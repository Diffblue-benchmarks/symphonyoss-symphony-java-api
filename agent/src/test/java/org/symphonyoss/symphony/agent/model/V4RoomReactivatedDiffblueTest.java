...
public class V4RoomReactivatedDiffblueTest {
   ...
   */
  @Test
  @MethodsUnderTest({"boolean V4RoomReactivated.equals(Object)", "int V4RoomReactivated.hashCode()"})
  public void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, v4RoomReactivated2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link V4RoomReactivated#equals(Object)}
   */
  @Test
  @MethodsUnderTest({"boolean V4RoomReactivated.equals(Object)", "int V4RoomReactivated.hashCode()"})
   ...
   */
  @Test
  @MethodsUnderTest({"void V4RoomReactivated.<init>()", "V4Stream V4RoomReactivated.getStream()",
      "void V4RoomReactivated.setStream(V4Stream)", "V4RoomReactivated V4RoomReactivated.stream(V4Stream)",
  ...
  public void testGettersAndSetters() {
    ...
    // Assert
    assertEquals("class V4RoomReactivated {\n" + "    stream: class V4Stream {\n" + "        streamId: null\n"
        + "        streamType: null\n" + "        roomName: null\n" + "        members: null\n"
        + "        external: null\n" + "        crossPod: null\n" + "    }\n" + "}", actualToStringResult);
    assertSame(actualV4RoomReactivated, actualStreamResult);
    assertSame(stream, actualV4RoomReactivated.getStream());
  }
}
