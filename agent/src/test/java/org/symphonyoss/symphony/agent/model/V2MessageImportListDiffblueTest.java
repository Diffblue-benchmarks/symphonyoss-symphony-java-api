...
public class V2MessageImportListDiffblueTest {
   ...
   */
  @Test
  @MethodsUnderTest({"boolean V2MessageImportList.equals(Object)", "int V2MessageImportList.hashCode()"})
  public void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, v2MessageImportList2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link V2MessageImportList#equals(Object)}
   */
  @Test
  @MethodsUnderTest({"boolean V2MessageImportList.equals(Object)", "int V2MessageImportList.hashCode()"})
   ...
   */
  @Test
  @MethodsUnderTest({"void V2MessageImportList.<init>()", "java.lang.String V2MessageImportList.toString()"})
