...
public class ChannelSubscriptionErrorDiffblueTest {
  /**
   * Test {@link ChannelSubscriptionError#equals(Object)}, and {@link
   * ChannelSubscriptionError#hashCode()}.
   *
   * <ul>
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean ChannelSubscriptionError.equals(Object)",
    "int ChannelSubscriptionError.hashCode()"
  })
  public void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(channelSubscriptionError.hashCode(), channelSubscriptionError2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link ChannelSubscriptionError#equals(Object)}
   */
  @Test
  @ManagedByDiffblue
  @MethodsUnderTest({
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void ChannelSubscriptionError.<init>()",
    "ChannelSubscriptionError ChannelSubscriptionError.code(String)",
    "String ChannelSubscriptionError.getCode()",
    "String ChannelSubscriptionError.getMessage()",
    "Long ChannelSubscriptionError.getUserId()",
    "ChannelSubscriptionError ChannelSubscriptionError.message(String)",
    "void ChannelSubscriptionError.setCode(String)",
    "void ChannelSubscriptionError.setMessage(String)",
    "void ChannelSubscriptionError.setUserId(Long)",
    "String ChannelSubscriptionError.toString()",
  ...
  public void testGettersAndSetters() {
    ...
    ChannelSubscriptionError actualMessageResult =
        actualChannelSubscriptionError.message("Not all who wander are lost");
    ...
    assertEquals(
        "class ChannelSubscriptionError {\n"
            + "    userId: 1\n"
            + "    code: Code\n"
