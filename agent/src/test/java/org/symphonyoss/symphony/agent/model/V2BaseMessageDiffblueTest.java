...
public class V2BaseMessageDiffblueTest {
  ...
  public void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, v2BaseMessage2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link V2BaseMessage#equals(Object)}
   */
  @Test
  @MethodsUnderTest({"boolean V2BaseMessage.equals(Object)", "int V2BaseMessage.hashCode()"})
   ...
   */
  @Test
  @MethodsUnderTest({"void V2BaseMessage.<init>()", "String V2BaseMessage.getId()",
      "String V2BaseMessage.getStreamId()", "String V2BaseMessage.getTimestamp()",
      "String V2BaseMessage.getV2messageType()", "V2BaseMessage V2BaseMessage.id(String)",
      "void V2BaseMessage.setId(String)", "void V2BaseMessage.setStreamId(String)",
      "void V2BaseMessage.setTimestamp(String)", "void V2BaseMessage.setV2messageType(String)",
      "V2BaseMessage V2BaseMessage.streamId(String)", "V2BaseMessage V2BaseMessage.timestamp(String)",
      "String V2BaseMessage.toString()", "V2BaseMessage V2BaseMessage.v2messageType(String)"})
  public void testGettersAndSetters() {
    ...
    assertEquals("class V2BaseMessage {\n" + "    id: 42\n" + "    timestamp: Timestamp\n"
